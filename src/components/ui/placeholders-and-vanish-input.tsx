  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none text-white bg-transparent h-full rounded-full focus:outline-none focus:ring-0 pl-4 pr-20",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className=" text-sm sm:text-base font-normal pl-4 text-left w-[calc(100%-2rem)] truncate"
            >
